...
export const CACHE_KEYS = {
  ...
  listPostsVer: 'list:posts:ver',
  listPosts: (ver: string, hash: string) => `list:posts:v${ver}:${hash}`,
  listPostsRecent: (ver: string, limit: number) => `list:posts:recent:v${ver}:${limit}`,
  listPostsFeed: (ver: string) => `list:posts:feed:v${ver}`,
  sitemap: 'sitemap:v1',
